...
if random_no == guess_no:
 print("Your guess is Correct, You won!")
    ...
    print("Your guest  is low") 
elif random_no:
    print("Your Guest is High")
...
censius = int(input("Enter the Temperature in the Degree  that  would like to convert:-"))
fahrenheit = (censius * 9/5 )  + 32
